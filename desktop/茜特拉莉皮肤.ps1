...
$script:voiceFile = Join-Path $PSScriptRoot '素材\语音-元素爆发·灭口交给你们俩了.wav'
$script:skillText = '元素爆发 · 诸曜饬令'
$script:voiceLine = '“灭口交给你们俩了！”'
$script:CARD_W = 320

$script:runKeyPath  = 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Run'
$script:runValueName = 'GenshenCitlaliSkin'
...
$script:skillLabel.Foreground = New-Solid 255 240 214 255
...
$script:skillLabel.Effect.Color = [System.Windows.Media.Color]::FromArgb(255, 216, 150, 255)
...
$script:lineLabel.Foreground = New-Solid 255 251 238 253
...
$script:lineLabel.Effect.Color = [System.Windows.Media.Color]::FromArgb(255, 240, 171, 252)
...
$card.BorderBrush = New-Solid 200 240 170 252
...
$flashBrush.GradientStops.Add((New-Object System.Windows.Media.GradientStop([System.Windows.Media.Color]::FromArgb(242, 250, 208, 255), 0))) | Out-Null
$flashBrush.GradientStops.Add((New-Object System.Windows.Media.GradientStop([System.Windows.Media.Color]::FromArgb(128, 192, 132, 252), 0.45))) | Out-Null
$flashBrush.GradientStops.Add((New-Object System.Windows.Media.GradientStop([System.Windows.Media.Color]::FromArgb(0, 88, 28, 135), 1))) | Out-Null
...
$script:ring.Stroke = New-Solid 230 226 168 255
...
for ($i = 0; $i -lt 3; $i++) {
  ...
  $slashBrush2.GradientStops.Add((New-Object System.Windows.Media.GradientStop([System.Windows.Media.Color]::FromArgb(0, 255, 224, 248), 0))) | Out-Null
  $slashBrush2.GradientStops.Add((New-Object System.Windows.Media.GradientStop([System.Windows.Media.Color]::FromArgb(242, 255, 224, 248), 0.3))) | Out-Null
  $slashBrush2.GradientStops.Add((New-Object System.Windows.Media.GradientStop([System.Windows.Media.Color]::FromArgb(230, 240, 171, 252), 0.6))) | Out-Null
  $slashBrush2.GradientStops.Add((New-Object System.Windows.Media.GradientStop([System.Windows.Media.Color]::FromArgb(0, 240, 171, 252), 1))) | Out-Null
...
function Invoke-Burst {
  ...
  for ($i = 0; $i -lt $script:stars.Count; $i++) {
    ...
    $sdy = (if (([math]::Floor($i / 5) % 2) -eq 0) { -1 } else { 1 }) * (90 + ($i % 4) * 22)
...
$pill.Background = New-Solid 230 24 12 48
$pill.BorderBrush = New-Solid 140 226 168 255
...
$pillLabel.Foreground = New-Solid 255 243 221 255
...
function Invoke-Uninstall {
  ...
  $res = [System.Windows.MessageBox]::Show(
    ('确定卸载茜特拉莉桌面皮肤吗？' + [char]10 + '将关闭程序、移除开机自启，并删除本桌面版文件夹。'),
    '茜特拉莉皮肤 · 一键卸载',
...
$menuPanel.Background = New-Solid 245 20 10 40
$menuPanel.BorderBrush = New-Solid 100 226 168 255
...
function Add-MenuLabel([string]$label) {
  ...
  $t.Foreground = New-Solid 160 240 214 255
...
function Add-MenuButton($label, $isDanger, $action) {
  ...
  $b.FontSize = 13
  $b.Cursor = 'Hand'
  if ($isDanger) { $b.Foreground = New-Solid 255 255 180 168 } else { $b.Foreground = New-Solid 255 243 221 255 }
  $b.Add_MouseEnter({ $_.Source.Background = New-Solid 90 120 60 200 })
...
function Add-MenuSep {
  ...
  $sep.Background = New-Solid 45 226 168 255
...
function Show-Menu([string]$mode, [double]$x, [double]$y) {
  ...
  Add-MenuButton '释放元素爆发「诸曜饬令」' $false { Invoke-Burst } | Out-Null
  Add-MenuLabel '切换壁纸'
