...
- **切换壁纸**：三张壁纸自由切换——壁纸·其一（立绘 800×1159）/ 壁纸·其二（2560×1440）/ 壁纸·其三（2560×1440），当前壁纸带 ✓ 标记
- 连续点击可重复触发；语音每次只播一条
...
└── 素材/
    ...
    ├── 茜特拉莉-壁纸2.jpg             壁纸原图（2560×1440，全画质模式使用）
    ├── 茜特拉莉-壁纸3.jpg             壁纸原图（2560×1440，全画质模式使用）
    ├── 茜特拉莉-web.jpg              立绘网页优化图（640×927，已内嵌进 client-standalone.js）
    ├── 茜特拉莉-壁纸2-web.jpg         壁纸网页优化图（1280×720，已内嵌进 client-standalone.js）
    ├── 茜特拉莉-壁纸3-web.jpg         壁纸网页优化图（1280×720，已内嵌进 client-standalone.js）
...
想用 2560×1440 原图壁纸（而非内嵌的 1280×720 优化图）时：
